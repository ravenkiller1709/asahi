...
static const char *fonts[]          = { "fontawesome:size=12", "cantarell:size=12" };
...
static const Key keys[] = {
 ...
 #include <X11/XF86keysym.h>
	...
	{ MODKEY|ShiftMask,             XK_w,      spawn,          SHCMD("nsxiv -t ~/.wallpapers/*") },
	{ MODKEY,			XK_comma,  spawn,          {.v = (const char*[]){ "dmenuunicode", NULL } } },
	...
	{ MODKEY,                       XK_x,      spawn,          SHCMD("$HOME/.scripts/sysact") },	
	{ MODKEY,                       XK_r,      quit,           {1} }, 
};
